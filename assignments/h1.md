...
Palvelinten hallinta-kurssin ensimmäisellä tunnilla kokeiltiin aikaansaada Saltilla Hello World-ohjelma. Ennen kuin aloin tuskailla edes perustason SLS-tiedostojen kanssa, testasin, ovatko master ja minion yhteydessä.
```
sudo salt '*' test.ping
```
Minion vastasi onnistuneesti.
